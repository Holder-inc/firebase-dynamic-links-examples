...
class _MainScreenState extends State<_MainScreen> {
  ...
  final String Link = 'https://flutterfiretests.page.link/RKxq';
  ...
  Future<void> _createDynamicLink(bool short) async {
    ...
    final DynamicLinkParameters parameters = DynamicLinkParameters(
      ...
      longDynamicLink: Uri.parse(
        'https://flutterfiretests.page.link/?efr=0&ibi=io.flutter.plugins.firebase.dynamiclinksexample&apn=io.flutter.plugins.firebase.dynamiclinksexample&imv=0&amv=0&link=https%3A%2F%2Fexample%2Fhelloworld',
      ),
                    ...
                    children: <Widget>[
                      ...
                      ElevatedButton(
                        onPressed: () async {
                          ...
                          final Uri? deepLink = data?.link;
                          print('dynamicLinks : $dynamicLinks');
